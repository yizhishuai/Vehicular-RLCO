...
### Main script for parametric simulations ###
"""
...
for n_sim in range(1):
    ...
    makeFigurePlot(n_vehicles, train_avg_total_times, labels, legend)
    plt.savefig('Figures/' + labels[1] + '.svg', figsize=[10,5])
    labels[1] = 'Training average agent processing times'
    makeFigurePlot(n_vehicles, train_avg_agent_times, labels, legend)
    plt.savefig('Figures/' + labels[1] + '.svg', figsize=[10,5])
    labels[1] = 'Testing success rate'
    makeFigurePlot(n_vehicles, test_success_rate, labels, legend)
    plt.savefig('Figures/' + labels[1] + '.svg', figsize=[10,5])
